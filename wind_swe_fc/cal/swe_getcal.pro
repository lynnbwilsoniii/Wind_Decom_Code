...
;
; IDL Procedure: swe_getcal.pro
;
; Author:     Mike Stevens (mstevens@cfa.harvard.edu)
;
; Purpose:    return requested calibration information for SWE faraday cups
;
; History:  06/01/12 This file created 
;
; SCCS Info
;
;           %Z%%M%   VERSION %I%    %G%  %U% 
...
pro swe_getcal, eff_area, i_angle
...
effarea_windsim  = eff_area
i_angle = DINDGEN(910)/10.0
