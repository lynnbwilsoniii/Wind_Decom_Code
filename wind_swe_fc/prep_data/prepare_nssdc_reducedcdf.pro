...
pro prepare_nssdc_reducedcdf, year, update_only=update_only
...
spawn, 'ls /crater/observatories/wind/ionspec/ionspec'+yyyy+'*.idl', file_list
if n_elements(file_list) ge 1 then $
  for i = 0, n_elements(file_list)-1 do spawn, 'gzip -f ' + file_list; just for uniformity's sake
