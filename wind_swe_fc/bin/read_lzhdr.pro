; @(#)read_lzhdr.pro  VERSION 1.3    5/10/96   14:48:37
...
readu,ifnum,fh
;fh = conv_vax_unix(fh) ----- STEVENS 11/14: This conversions appears
...
if (fh.rln EQ 0) then fh.rln = 11552 ; assume SWE length default on error!
return,fh
end
