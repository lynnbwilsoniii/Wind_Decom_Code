...
helparr=['Command        Action',$
         ...
         '   9      20 panels, both collectors and sum, no fits',      $
...
case request of
    ...
    '9': begin
      print, ' ','20 Panels with seperate collectors - Please choose an option:'
      print, '1. Current vs. Energy Window (default)'
      print, '2. Distribution Function vs. Proton Velocity'
      print, '3. Current vs. Proton Velocity'
      print, '4. Current vs. Voltage'
      ...
      if (req3 eq '2') then req3 = 2 else req3 = 1
      case req2 of
        '4': splot1f_ic, /vsvolt, cup=req3
        '3': splot1f_ic, /vsvel, cup=req3
        '2': splot1f_ic, /dist, cup=req3
        else: splot1f_ic, cup=req3
      endcase
     end 
    'e': begin
        ssplot2f
    ...
    'm': moments
    'p': splot, PRINTER='lj664', FILE=OUTFILE
    'P': startplot
    's': begin
        skip=0
