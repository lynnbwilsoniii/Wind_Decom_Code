	...
	wa.field1(5): BEGIN  ;select mjf record
        ...
        wa.button1(2): begin
           case event.value of
             ...
             1: begin
                  ms_hms,lz.ms,h,m,s           ;get hhmmss.ms from msec of day
                  prt_hdr,0,lz,h,m,s           ;print major frame header
                endcase
             2: prt_mf,0,lz.mf,lz.recn         ;print major frame data
             3: prt_ihk,0,ihk,lz               ;print instr hk data
...
;widget interface to select and read lz records
  ...
  wa.field1(5)=cw_field(wa.base,title='recn',/return_events)
  ...
  wa.field1(2)=cw_field(cbase1,title='spincnt',$
    value='',xsize=20,/string,/noedit)

  wa.field1(3)=cw_field(cbase1,title='spinperiod',$
    value='',xsize=20,/string,/noedit)
