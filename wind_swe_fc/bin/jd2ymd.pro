...
;-------------------------------------------------------------
    ...
    pro jd2ymd, jdd, y, m, d, dateString=dateString,  $
                help=hlp
    ...
    dateString = string( y[0] ) + string( m[0], format='(i2.2)' ) + $
                 string( d[0], format='(i2.2)' ) 
    dateString = STRCOMPRESS(dateString, /REMOVE_ALL)
