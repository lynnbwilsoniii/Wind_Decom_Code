; @(#)idl_shell2.pro  VERSION 1.16    6/20/96   14:34:24
;
...
REPEAT BEGIN
    ...
    if ( mode eq 1) then utc_1stspn = hkm1(1).offs + [0,1,2,3,4,5,6]
    if ( (mode eq 2) or (mode eq 11) ) then $
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        if ( (mode eq 2) or (mode eq 11) ) then BEGIN
           fcbl = fcblm2
           numfcblocks = 17
        endif
