...
c    files containing subroutines and functions called by sdf_lister:
      include 'calib_lib.f95'
      include 'date_time_subr.f95'
      include 'decode_lib.f95'
      include 'derf.f95'
      include 'open_sdf_sl.f95'
      include 'SAMPEX_TIMCON.f95'
      include 'sdf_abr_subrout.f95'
      include 'sdf_ave_subrout.f95'
      include 'sdf_flux_subrout.f95'
      include 'sdf_mask_subrout.f95'
      include 'sdf_matrix.f95'
      include 'sdf_mdata.f95'
      include 'sdf_omni_subrout.f95'
      include 'sdf_pha_subrout.f95'
      include 'sdf_sect_subrout.f95'
      include 'sdf_sect_subrout2.f95'
      include 'sdf_STEPKP_subrout.f95'
      include 'sdf_subrout.f95'
      include 'sdf_subrout2.f95'
      include 'time_lib.f95'
      include 'trigger_effic.f95'
...
c                    4/26/96 by J. Dwyer changed directory of trigger_effic.f95 above
...
c                                          3)  removed kp_append.f95 include file, use hex_include only
...
c			        trigger_effic.f95 input file     
c
      include 'hex_include.inc'   ! include type declarations. Used by hex_to_unf
...
c                                   ********************  
      configfile = adjustl(trim(control_path)) // 'sdf_rom_spikes.cfg'   ! default value /gm
c
...
c
c
c                                     Main loop through multiple SDFas
c                              ********************************
...
c
c
      print *, 'sdf_rom_spikes is finished'
      stop
c
