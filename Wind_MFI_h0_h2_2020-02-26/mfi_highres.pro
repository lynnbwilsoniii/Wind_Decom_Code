FUNCTION MFI_HIGHRES, DATE=DATE, OUTER_MAG=OUTER_MAG, SPHA_ONLY=SPHA_ONLY, CNT=COUNTS, PAY=PAYLOAD, $
...
for i_h=1, n_harm do begin
   ...
   noise_x += (total(payb_arr.x*cos_i_h_omega)/total_cos_i_h_omega_sq*cos_i_h_omega + $
               total(payb_arr.x*sin_i_h_omega)/total_sin_i_h_omega_sq*sin_i_h_omega)
   noise_y += (total(payb_arr.y*cos_i_h_omega)/total_cos_i_h_omega_sq*cos_i_h_omega + $
               total(payb_arr.y*sin_i_h_omega)/total_sin_i_h_omega_sq*sin_i_h_omega)
   noise_z += (total(payb_arr.z*cos_i_h_omega)/total_cos_i_h_omega_sq*cos_i_h_omega + $
               total(payb_arr.z*sin_i_h_omega)/total_sin_i_h_omega_sq*sin_i_h_omega)
endfor
