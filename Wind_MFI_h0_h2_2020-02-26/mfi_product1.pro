PRO MFI_PRODUCT1, START_DATE=START_DATE, END_DATE=END_DATE, VERSION=VERSION, HIRES=HIGHRES, CNT=COUNTS, PAY=PAYLOAD, $
...
while (int_start_epoch lt end_epoch) do begin
   ...
   result_in = mfi_highres1(date=int_start_date, outer_mag=0, spha_only=spha_only, cnt=counts, pay=payload, $
                           no_outlier_removal=no_outlier_removal, no_noise_correction=no_noise_correction, $
   ...
   if n_outer_mag_cur_date_list gt 0 then begin
      result_ou = mfi_highres1(date=int_start_date, outer_mag=1, spha_only=spha_only, cnt=counts, pay=payload, $
                              no_outlier_removal=no_outlier_removal, no_noise_correction=no_noise_correction, $
