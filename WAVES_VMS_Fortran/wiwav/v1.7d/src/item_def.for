...
$IF ABSOFT_FORTRAN
	integer*4	max_fixed_value_bytes
...
$IF ABSOFT_FORTRAN
	integer*4	max_lookup_tbl_entries
...
$IF ABSOFT_FORTRAN
	...
	integer*4 NE_OP
	integer*4 AND_OP
	integer*4 BETWEEN_OP_INC
	integer*4 BETWEEN_OP_EXC
	integer*4 NOT_BETWEEN_OP
	integer*4 IS_BIT_SET_OP
	integer*4 OR_OP
	integer*4 DATE_LT_OP
	integer*4 DATE_LE_OP
	integer*4 DATE_GT_OP
	integer*4 DATE_GE_OP
