...
C	DATA SCET8/5844.0D00/		! JAN-01-1998
...
C	print*,'open, TMCHANNEL,ok=',TMCHANNEL,ok
	if (ok.ne.1) then
	  print*, 'Cannot open t/m channel, yyyy mm dd',yyyy,mm,dd
	  scet8 = scet8 + 1.d00
	  if (scet8.le.scetend) go to 100
	endif
c
	scet = 0.
...
c
c	DO N=1,100
c	  WRITE(69,169) 11-N,((HIST(IFR,IRX,N),IFR=1,5),IRX=1,4)
c	ENDDO
 169	FORMAT(I6,20F6.0)
