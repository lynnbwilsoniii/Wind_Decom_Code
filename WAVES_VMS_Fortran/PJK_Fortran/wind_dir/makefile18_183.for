...
c 1111	FORMAT(I10,I8,I10,A2,I2,I4,3F7.0,F7.2,F6.3,F7.0,F6.1,3F7.1,2F7.1
     1		,F6.3)
C	1111 IS NOW 113 CHARACTERS
 1111	FORMAT(I10,I7,I10,A2,I2,I4,3F7.0,F7.2,F6.3,F7.0,F6.1,3F7.1,2F7.1
     1		,F6.3)
C
	OK = W_EVENT(CH,'HK')
	ITEM = 'APM_X_PEAK'
