...
c	CHARACTER*80	YYYYMMDD
	...
	INTEGER*4 	OK,GET_STREAM_NAME,TMCHANNEL,CDFCHANNEL
...
C	print*, 'STOP IN MISSION_SCAN12'
c	TMCHANNEL = 20
c	call makefile(tmchannel)
C
	print*, 'STOP IN MISSION_SCAN24'
	CLOSE(UNIT=70)
	STOP
	END
	options/extend_source
