...
C
	WRITE(79,*) ' '	
	WRITE(79,*) 'IN VMATRIX, N1,N2',N1,N2	
C
	DO N = 1,2048
	  WT(N) = 1.
	ENDDO
	IF(N2-N1.LT.90) THEN
	  WRITE(79,*) 'VARIANCE MATRIX FOR SAMPLES EXCEPT',N1,' TO',N2	
	  DO N = N1,N2
	    WT(N) = 0.
	  ENDDO
	ELSE
	  WRITE(79,*) 'VARIANCE MATRIX FOR ALL SAMPLES '
	ENDIF
C
C	subtract averages
C
...
C
	...
	PRINT*,EVAL,' sum',eval(1)+eval(2)+eval(3)
	PRINT*,'EIGENVECTORS'
