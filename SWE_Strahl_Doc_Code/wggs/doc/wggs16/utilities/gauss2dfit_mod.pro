...
Function gauss2dfit_mod, z, a, x, y, NEGATIVE = neg, TILT=tilt
;+
; NAME:
;	GAUSS2DFIT
;
...
;-
;
print,'RJF modified version of gauss2dfit'
...
;!!! The keyword NTERMS in the call to gaussfit causes the procedure to fail
