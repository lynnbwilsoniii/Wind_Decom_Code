...
recs=[1,100];[550,590];[1,2000]  ;  whole file[1,2000]
...
if scimode ne 1 and scimode ne 2 and scimode eq 4 and scimode ne 6 then begin  
...
for ispin=0,nspins-1 do begin
  ...
  ;---------------- prepare parameters for the fortran moments integration ----
