...
endofplot = 19981231l  ;19981030l 
  tpb5_end=ymd_pb5(endofplot)  
  elapsec_end=pb5_elapsec(tpb5_end,pb5ref)

yrmd_begin=long(19980514) ; 1998, 134, 55749000; bias change (66,64)on this day
pb5_begin=ymd_pb5(yrmd_begin)
elapsec_begin=0;pb5_elapsec(pb5_begin,pb5ref)  ;0
...
;group 5_1
   yrmd5_1=long(19980611) ; 1998, 162, 0
   pb5_change5_1=ymd_pb5(yrmd5_1)
   elapsec_change5_1=pb5_elapsec(pb5_change5_1,pb5ref)         
   set5_1=ebias1 eq 66 and ebias2 eq 64 and $
            elapsec ge elapsec_change4_5 and elapsec lt elapsec_change5_1
   w5_1=where(set5_1,nw5_1)
   clr5_1=50
   linfit5_1=[1,1,1,1,1,1]
   
 ;group 5_2    
   yrmd5_2=long(19980728) ;1998, 209, 48669000; bias change (71,69) on this day
   pb5_change5_2=ymd_pb5(yrmd5_2)
   pb5_change5_2(2)=48669000l
   elapsec_change5_2=pb5_elapsec(pb5_change5_2,pb5ref)        
   set5_2=ebias1 eq 66 and ebias2 eq 64 and $
            elapsec gt elapsec_change5_1 and elapsec le elapsec_change5_2
   w5_2=where(set5_2,nw5_2)
   clr5_2=50
   linfit5_2=[1,1,1,1,1,1]  
...
;group 6
   ...
   set6=ebias1 eq 71 and ebias2 eq 69 and $
            elapsec gt elapsec_change5_2 and elapsec le elapsec_change6
   w6=where(set6,nw6)
   clr6=90
   linfit6=[1,1,1,1,1,1]

;group 7
   yrmd7=long(19981021)  ;1998, 294, 0      ;begin setting flat relgains 
   pb5_change7=ymd_pb5(yrmd7)
   pb5_change7(2)=86400000l
   elapsec_change7=pb5_elapsec(pb5_change7,pb5ref)
   set7=ebias1 eq 73 and ebias2 eq 69 and $
            elapsec gt elapsec_change6 and elapsec le elapsec_change7
   w7=where(set7,nw7)
   clr7=115
   linfit7=[1,1,1,1,1,1]
   ...
   print,nw1+nw2+nw3+nw4+nw5_1+nw5_2+nw6+nw7,n_elements(ebias1)
   if nw1+nw2+nw3+nw4+nw5_1+nw5_2+nw6+nw7 ne n_elements(ebias1) then begin
...
oplot,elapsec(w5_1),ebias1(w5_1),psym=4,symsize=symsize,color=clr5_1
oplot,elapsec(w5_1),ebias2(w5_1),psym=4

oplot,elapsec(w5_2),ebias1(w5_2),psym=4,symsize=symsize,color=clr5_2
oplot,elapsec(w5_2),ebias2(w5_2),psym=4

oplot,elapsec(w6),ebias1(w6),psym=4,symsize=symsize,color=clr6
oplot,elapsec(w6),ebias2(w6),psym=4

oplot,elapsec(w7),ebias1(w7),psym=4,symsize=symsize,color=clr7
oplot,elapsec(w7),ebias2(w7),psym=4
...
oplot,elapsec(w5_1),z(i,w5_1),psym=4,symsize=symsize,color=clr5_1    
plotcrvfit,elapsec(w5_1),reform(z(i,w5_1)),mncts(w5_1),i,eqwts,c,yfit,clr5_1,$
  linfit=linfit5_1(i)

oplot,elapsec(w5_2),z(i,w5_2),psym=4,symsize=symsize,color=clr5_2    
plotcrvfit,elapsec(w5_2),reform(z(i,w5_2)),mncts(w5_2),i,eqwts,c,yfit,clr5_2,$
  linfit=linfit5_2(i)
  
oplot,elapsec(w6),z(i,w6),psym=4,symsize=symsize,color=clr6  
plotcrvfit,elapsec(w6),reform(z(i,w6)),mncts(w6),i,eqwts,c,yfit,clr6,$
  linfit=linfit6(i)

oplot,elapsec(w7),z(i,w7),psym=4,symsize=symsize,color=clr7  
plotcrvfit,elapsec(w7),reform(z(i,w7)),mncts(w7),i,eqwts,c,yfit,clr7,$
  linfit=linfit7(i)
...
if usegetrelgains then begin
  ...
  rgw5_1=fltarr(6,n_elements(elapsec(w5_1)))    
   for i=0,n_elements(elapsec(w5_1))-1 do begin
     pb5tm=elapsec_pb5(elapsec(w5_1(i)),pb5ref) 
     sectm=pb5_sec(pb5tm)
     getrelgains,rg,sectm,relgainchange 
     rgw5_1(*,i)=rg
   endfor 

  rgw5_2=fltarr(6,n_elements(elapsec(w5_2)))    
   for i=0,n_elements(elapsec(w5_2))-1 do begin
     pb5tm=elapsec_pb5(elapsec(w5_2(i)),pb5ref) 
     sectm=pb5_sec(pb5tm)
     getrelgains,rg,sectm,relgainchange 
     rgw5_2(*,i)=rg
   endfor 
   
  rgw6=fltarr(6,n_elements(elapsec(w6)))    
   for i=0,n_elements(elapsec(w6))-1 do begin
     pb5tm=elapsec_pb5(elapsec(w6(i)),pb5ref) 
     sectm=pb5_sec(pb5tm)
     getrelgains,rg,sectm,relgainchange 
     rgw6(*,i)=rg
   endfor 
   
  rgw7=fltarr(6,n_elements(elapsec(w7)))    
   for i=0,n_elements(elapsec(w7))-1 do begin
     pb5tm=elapsec_pb5(elapsec(w7(i)),pb5ref) 
     sectm=pb5_sec(pb5tm)
     getrelgains,rg,sectm,relgainchange 
     rgw7(*,i)=rg
   endfor 

  elapsec_after=[elapsec_change7,elapsec_end] 
  rg_after=fltarr(6,n_elements(elapsec_after))    
   for i=0,n_elements(elapsec_after)-1 do begin
...
;if i eq 2 then yrange=[0,24] else if i eq 3 then yrange=[0,12] else $
;  yrange=y_range
...
oplot,elapsec(w5_1),z(i,w5_1),psym=4,symsize=symsize,color=clr5_1
if usegetrelgains then oplot,elapsec(w5_1),rgw5_1(i,*),color=200 else $
 plotcrvfit,elapsec(w5_1),reform(z(i,w5_1)),mncts(w5_1),i,eqwts,c,yfit,clr5_1,$
  linfit=linfit5_1(i)
if createsavefile then coeff(*,i,8)=c

oplot,elapsec(w5_2),z(i,w5_2),psym=4,symsize=symsize,color=clr5_2
if usegetrelgains then oplot,elapsec(w5_2),rgw5_2(i,*),color=200 else $
 plotcrvfit,elapsec(w5_2),reform(z(i,w5_2)),mncts(w5_2),i,eqwts,c,yfit,clr5_2,$
  linfit=linfit5_2(i)
if createsavefile then coeff(*,i,9)=c

oplot,elapsec(w6),z(i,w6),psym=4,symsize=symsize,color=clr6
if usegetrelgains then oplot,elapsec(w6),rgw6(i,*),color=200 else $
  plotcrvfit,elapsec(w6),reform(z(i,w6)),mncts(w6),i,eqwts,c,yfit,clr6,$
  linfit=linfit6(i)
if createsavefile then coeff(*,i,10)=c

oplot,elapsec(w7),z(i,w7),psym=4,symsize=symsize,color=clr7
if usegetrelgains then oplot,elapsec(w7),rgw7(i,*),color=200 else $
  plotcrvfit,elapsec(w7),reform(z(i,w7)),mncts(w7),i,eqwts,c,yfit,clr7,$
  linfit=linfit7(i)
if createsavefile then coeff(*,i,11)=c
