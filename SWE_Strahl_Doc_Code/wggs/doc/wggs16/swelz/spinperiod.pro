...
0: begin
     ...
     if sec_dis gt 0.d0 then begin
       ...
       if sp.spinp gt 0.9*3.05 and sp.spinp lt 1.1*3.05 then begin ;good spin period
         ...
         sp.datayes=1                 ;set flag that spinperiod is known for
                                      ;at least one record this file
